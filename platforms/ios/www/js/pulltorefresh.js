(function (global, factory) {
  ...
  var _defaults = {
    ...
    classPrefix: 'ptr--',
    cssProp: 'min-height',
    iconArrow: '<img src="img/loader1.png" style="height:50px;width:50px;border-radius:4px; z-index: 2000;">',
    iconRefreshing: '',
    instructionsPullToRefresh: '',
    instructionsReleaseToRefresh: '',
    instructionsRefreshing: '<img src="img/loader2.gif" style="height:50px;width:50px;border-radius:4px; z-index: 2000;">',
    refreshTimeout: 60000*2,
  ...
  function _setupEvents() {
    ...
    function _onTouchEnd() {
      ...
      if (_shared.state === 'releasing' && _shared.distResisted > _el.distThreshold) {
        ...
        _shared.timeout = setTimeout(closeProgressDialog, _el.refreshTimeout);
        _el.callApi(function () {  });
      } else {
        if (_shared.state === 'refreshing') {
          return;
        }
    ...
    return {
      ...
      destroyProgress: function destroyProgress() {
        _ptr.onReset(_el);
      },
    };
  }
  ...
  function _setupHandler(options) {
    ...
    _handler.destroyProgress = function () {
      // stop pending any pending callbacks

     _ptr.onReset(_handler);
